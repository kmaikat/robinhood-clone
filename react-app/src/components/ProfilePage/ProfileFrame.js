        ...
        <div className={styles.profilePictureFrame}>
            {
                ...
                <>
                    ...
                    <div className={styles.addProfile} onClick={() => dispatch(deleteProfileImage())}><i className="fa-solid fa-xmark"></i></div>
                </> :
                <>
                    ...
                    <label htmlFor='upload-btn' className={styles.addProfile} onClick={handleUpload}><i className="fa-solid fa-plus"></i></label>
                </>
            }
